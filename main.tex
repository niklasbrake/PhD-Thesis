...
\usepackage{lipsum}
\usepackage{tabto}
%\usepackage[version=4]{mhchem} % for reactions.
% \numberwithin{equation}{section} % to make Eq. 2.1, e.g.
% \usepackage{chngcntr} % to change figure counter
% \counterwithin{figure}{section} % figure 1.1, 2.1, etc.
...
\include{chapter3-AvC}

\include{chapter4-VE}

\include{chapter5-concl}
...
\bibliography{Bibliography/library_AvC,Bibliography/library_general,Bibliography/library_Tr1,Bibliography/library_VE}
\endgroup
